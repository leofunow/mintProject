...
export class IndexComponent implements OnInit {
  ...
  cardinform =
    [{
      ...
      {head: 'Заголовок', body: 'Пробный текст'},
      {head: 'Последний заголовок', body: 'Плейсхолдер для заказчика'}];
  ...
  publications: Publication[] = [{
    img: 'assets/img/posts/post1.png',
  ...
  changeCardStyle() {
    switch (this.cardtype % 3) {
      case 0:
        this.cardstyle = ['z-index: 2', 'z-index: 1', 'z-index: 0'];
        break;
      case 1:
        this.cardstyle = ['z-index: 1', 'z-index: 2', 'z-index: 0'];
        break;
      case 2:
        this.cardstyle = ['z-index: 0', 'z-index: 1', 'z-index: 2'];
        break;
    }
  }
